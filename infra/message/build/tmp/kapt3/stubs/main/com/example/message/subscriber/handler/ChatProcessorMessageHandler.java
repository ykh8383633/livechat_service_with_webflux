...
public abstract class ChatProcessorMessageHandler implements com.example.message.subscriber.handler.MessageHandler {
    ...
    protected abstract java.util.List<com.example.message.channel.Channel> getAllChannels();
